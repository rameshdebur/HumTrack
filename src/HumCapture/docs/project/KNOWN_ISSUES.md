...
| HC-KI-016 | HumCapture is untracked in the parent Git repository | Parent commit cannot identify HumCapture source; controlled release creation is blocked | Explicitly authorize, review, and commit the bounded subsystem, then create a clean approved build identity |
