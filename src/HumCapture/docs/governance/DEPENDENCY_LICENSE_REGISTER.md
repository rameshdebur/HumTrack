...
SBOM baseline: 0.1.0-i0.4b-c14q, generated 2026-09-19T07:27:01.137Z.
...
|---|---|---|---|---|
| HumTrack/HumCapture **0.1.0-i0.4b-c14q** | First-party acquisition subsystem | [First-party](#first-party) | [1](SBOM_POLICY.md) | DECLARATION_RECORDED_NOT_LEGAL_APPROVAL: Baseline producer/distribution licence before release; not covered by third-party permission. |
...
| HumCapture/HumCapture CI **0.1.0-i0.4b-c14q** | Development/test/CI | [First-party](#first-party) | [1](SBOM_POLICY.md) | DECLARATION_RECORDED_NOT_LEGAL_APPROVAL: Baseline producer/distribution licence before release; not covered by third-party permission. |
