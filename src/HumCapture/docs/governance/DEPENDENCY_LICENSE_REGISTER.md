...
|---|---|---|---|---|
| HumTrack/HumCapture **0.1.0-i0.4b-c14r** | First-party acquisition subsystem | [First-party](#first-party) | [1](SBOM_POLICY.md) | DECLARATION_RECORDED_NOT_LEGAL_APPROVAL: Baseline producer/distribution licence before release; not covered by third-party permission. |
...
| HumCapture/HumCapture CI **0.1.0-i0.4b-c14r** | Development/test/CI | [First-party](#first-party) | [1](SBOM_POLICY.md) | DECLARATION_RECORDED_NOT_LEGAL_APPROVAL: Baseline producer/distribution licence before release; not covered by third-party permission. |
